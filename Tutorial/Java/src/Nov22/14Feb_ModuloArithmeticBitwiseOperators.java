...
class Iterator{
    public Node[] nodes; // hashtable of hashMap
    int pointer = -1;
    Node currNode;
    ...
    // to prevent index out of bounds, we've added pointer < nodes.length-1
    public void next(){    
...
class HashMapCustom{
    ...
    // number of keys present in hashMap
    public int size(){
        int count = 0;
...
class Main {
    ...
    public static void main(String args[]) {
        ...
        */
        ...
        //KDistinct(arr,4);
        //System.out.println(getRem(6,3,36));
        //long start1 = System.nanoTime();
        //System.out.println(getRem(6,102345000,55));
        //long end1 = System.nanoTime();
        //System.out.println("time taken 1st = " + (end1-start1));
        
        //long start2 = System.nanoTime();
        //System.out.println(getRemOptimized(6,102345000,55));
        //long end2 = System.nanoTime();
        //System.out.println("time taken 2nd = " + (end2-start2));
        System.out.println(ModInverse(14,5));
    }
